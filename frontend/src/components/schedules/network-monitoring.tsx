...
export function NetworkMonitoring() {
  ...
  if (isLoading || !data) {
    return (
      <section className="overflow-hidden rounded-xl bg-white p-8 shadow-sm ring-1 ring-black/5">
        <p className="text-sm text-muted-foreground">Loading network stats...</p>
      </section>
    )
  }
