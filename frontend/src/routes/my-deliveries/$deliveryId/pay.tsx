...
import { packageTypeLabel, sizeLabel, weightBandLabel } from "@/lib/delivery";
...
function DeliveryNotFound() {
  return (
    <div className="app-page min-h-svh bg-[#f5f5f7]">
      ...
      <main className="mx-auto max-w-180 px-6 py-16 text-center">
...
function PayDeliveryPage() {
  ...
  if (deliveryQuery.isLoading) {
    return (
      <div className="app-page min-h-svh bg-[#f5f5f7]">
        <Header activeLink="my-deliveries" />
        <main className="mx-auto max-w-180 px-6 py-16">
  ...
  return (
    <div className="app-page min-h-svh bg-[#f5f5f7]">
      <Header activeLink="my-deliveries" />
      <main className="mx-auto max-w-180 px-4 py-8 sm:px-6 lg:px-8 lg:py-14">
        <motion.div
          initial="hidden"
          animate="visible"
